          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-6 border-b-2 py-6 border-l-8	pb-6 border-opacity-0">
              <div id="roadmap" className="flex flex-wrap lg:flex-nowrap justify-around items-center">
                    <div className="lg:w-full">
                      <h1 className="text-4xl PermanentMarker-Regular text-black font-bold">Do you have a Slowmate roadmap? </h1>
                      <p className="text-2xl PermanentMarker-Regular text-black ">
            ...
            <div className="mt-6 border-b-2 py-6 border-l-8	pb-6 border-opacity-0">
                    <div className="lg:w-full">
                        <h1 className="text-4xl PermanentMarker-Regular text-black font-bold">How do we read the Slowmate world maps? </h1>                   
                        <p className="text-2xl PermanentMarker-Regular text-black ">
